...
INSERT INTO tasks (userID, taskname, description, estimate, total, completed, abandoned) VALUES (1, 'task_name_1', 'task description etc etc etc', 500, 1, false, false, false);
...
INSERT INTO tasks (userID, taskname, description, estimate, total, completed, abandoned) VALUES (2, 'task_name_1', 'task 1 description etc etc etc', 8000, 10, true, false, false);
...
INSERT INTO tasks (userID, taskname, description, estimate, total, completed, abandoned) VALUES (2, 'task_name_2', 'task 2 description etc etc etc', 80, 100, false, true, false);
...
INSERT INTO tasks (userID, taskname, description, estimate, total, completed, abandoned) VALUES (2, 'task_name_3', 'task 3 description etc etc etc', 1, 1, false, false, true);
